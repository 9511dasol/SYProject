  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        />
        <span className="absolute bottom-2.5 right-3 text-[10px] text-fg-disabled select-none">
          {value.length}/500
        </span>
      </div>
      ...
      {/* 예시 프롬프트 칩 */}
      <div>
        <p className="text-[10px] font-semibold text-fg-subtle uppercase tracking-wider mb-1.5">
          예시 프롬프트
        </p>
            ...
            <button
              ...
              className={[
                ...
                value === example
                  ...
                  : 'border-border bg-surface-2 text-fg-muted hover:border-indigo-200 dark:hover:border-indigo-700 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/30',
